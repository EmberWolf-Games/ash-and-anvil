  ...
  static defineSchema() {
    return {
      ...
      defenses: new SchemaField({
        resistances: new StringField({ initial: "" }),
        immunities: new StringField({ initial: "" }),
        vulnerabilities: new StringField({ initial: "" }),
        conditionImmunities: new StringField({ initial: "" }),
      }),
      proficiencies: new SchemaField({
        ...
        weapons: new StringField({ initial: "" }),
        tools: new StringField({ initial: "" }),
        languages: new StringField({ initial: "" }),
        gameSets: new StringField({ initial: "" }),
