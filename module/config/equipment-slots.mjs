...
export const MANNEQUIN_DISPLAY = [
  ...
  { storageKey: "body", abbrKey: "ASHANVIL.EquipAbbrBody", group: "body", top: 21, left: 50, size: SLOT_SIZE },
  ...
  { storageKey: "chest", abbrKey: "ASHANVIL.EquipAbbrChest", group: "body", top: 28, left: 50, size: SLOT_SIZE },
