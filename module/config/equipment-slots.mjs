...
export const MANNEQUIN_DISPLAY = [
  ...
  { storageKey: "body", abbrKey: "ASHANVIL.EquipAbbrBody", group: "body", top: 17, left: 50, size: SLOT_SIZE },
  { storageKey: "shoulders", abbrKey: "ASHANVIL.EquipAbbrShoulders", group: "body", top: 20, left: 24, size: SLOT_SIZE },
  { storageKey: "shoulders", abbrKey: "ASHANVIL.EquipAbbrShoulders", group: "body", top: 20, left: 76, size: SLOT_SIZE },
  { storageKey: "chest", abbrKey: "ASHANVIL.EquipAbbrChest", group: "body", top: 26, left: 50, size: SLOT_SIZE },
  { storageKey: "leftArm", abbrKey: "ASHANVIL.EquipAbbrArm", group: "body", top: 30, left: 10, size: SLOT_SIZE },
  { storageKey: "rightArm", abbrKey: "ASHANVIL.EquipAbbrArm", group: "body", top: 30, left: 90, size: SLOT_SIZE },
  { storageKey: "naturalArmor", abbrKey: "ASHANVIL.EquipAbbrNatural", group: "body", top: 26, left: 68, size: SLOT_SIZE },
  { storageKey: "hands", abbrKey: "ASHANVIL.EquipAbbrHands", group: "body", top: 38, left: 16, size: SLOT_SIZE },
  { storageKey: "hands", abbrKey: "ASHANVIL.EquipAbbrHands", group: "body", top: 38, left: 84, size: SLOT_SIZE },
  { storageKey: "waist1", abbrKey: "ASHANVIL.EquipAbbrWaist", group: "waist", top: 46, left: 34, size: SLOT_SIZE },
  { storageKey: "waist2", abbrKey: "ASHANVIL.EquipAbbrWaist", group: "waist", top: 46, left: 50, size: SLOT_SIZE },
  { storageKey: "waist3", abbrKey: "ASHANVIL.EquipAbbrWaist", group: "waist", top: 46, left: 66, size: SLOT_SIZE },
  { storageKey: "legs", abbrKey: "ASHANVIL.EquipAbbrLegs", group: "body", top: 62, left: 38, size: SLOT_SIZE },
  { storageKey: "legs", abbrKey: "ASHANVIL.EquipAbbrLegs", group: "body", top: 62, left: 62, size: SLOT_SIZE },
  { storageKey: "feet", abbrKey: "ASHANVIL.EquipAbbrFeet", group: "body", top: 88, left: 38, size: SLOT_SIZE },
  { storageKey: "feet", abbrKey: "ASHANVIL.EquipAbbrFeet", group: "body", top: 88, left: 62, size: SLOT_SIZE },
];
